...
public enum GraphQLErrorType {
    ...
    FETCH_DIRECTIVE_NOT_EXIST(-51, "object type field must have @fetch directive: %s"),
    FETCH_FROM_ARGUMENT_NOT_EXIST(-52, "from argument not exist in @fetch directive: %s"),
    FETCH_TO_ARGUMENT_NOT_EXIST(-53, "to argument not exist in @fetch directive: %s"),
    FETCH_PROTOCOL_ARGUMENT_NOT_EXIST(-54, "protocol argument not exist in @fetch directive: %s"),
    FETCH_FROM_FIELD_NOT_EXIST(-54, "fetch from field not exist: %s"),
    FETCH_TO_OBJECT_NOT_EXIST(-55, "fetch to object not exist: %s"),
    FETCH_TO_FIELD_NOT_EXIST(-56, "fetch to field not exist: %s"),
    FETCH_WITH_TYPE_ARGUMENT_NOT_EXIST(-57, "fetch with type to field not exist: %s"),
    FETCH_WITH_FROM_ARGUMENT_NOT_EXIST(-58, "fetch with type from field not exist: %s"),
    FETCH_WITH_TO_ARGUMENT_NOT_EXIST(-59, "fetch with type to field not exist: %s"),
    FETCH_WITH_TYPE_NOT_EXIST(-60, "fetch with type not exist: %s"),
    FETCH_WITH_FROM_FIELD_NOT_EXIST(-61, "fetch with type from field not exist: %s"),
