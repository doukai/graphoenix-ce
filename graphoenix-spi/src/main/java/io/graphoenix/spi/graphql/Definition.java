  ...
  static Definition of(GraphqlParser.DefinitionContext definitionContext) {
    if (definitionContext.operationDefinition() != null) {
      ...
      if (definitionContext.typeSystemDefinition().schemaDefinition() != null) {
        ...
        if (definitionContext.typeSystemDefinition().typeDefinition().scalarTypeDefinition()
            != null) {
          return new ScalarType(
              definitionContext.typeSystemDefinition().typeDefinition().scalarTypeDefinition());
        } else if (definitionContext.typeSystemDefinition().typeDefinition().enumTypeDefinition()
            != null) {
          return new EnumType(
              definitionContext.typeSystemDefinition().typeDefinition().enumTypeDefinition());
        } else if (definitionContext.typeSystemDefinition().typeDefinition().objectTypeDefinition()
            != null) {
          return new ObjectType(
              definitionContext.typeSystemDefinition().typeDefinition().objectTypeDefinition());
        } else if (definitionContext
                .typeSystemDefinition()
                .typeDefinition()
                .interfaceTypeDefinition()
            != null) {
          return new InterfaceType(
              definitionContext.typeSystemDefinition().typeDefinition().interfaceTypeDefinition());
        } else if (definitionContext
                .typeSystemDefinition()
                .typeDefinition()
        ...
        return new DirectiveDefinition(
            definitionContext.typeSystemDefinition().directiveDefinition());
      }
      ...
      if (definitionContext.typeSystemExtension().schemaExtension() != null) {
        ...
        if (definitionContext.typeSystemExtension().typeExtension().scalarTypeExtensionDefinition()
            != null) {
          return new ScalarType(
              definitionContext
                  .typeSystemExtension()
