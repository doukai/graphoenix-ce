...
public class Field extends AbstractDefinition implements Selection {
  ...
  public Field(
      ...
      ExecutableElement fieldExecutableElement,
      AnnotationMirror fieldAnnotationMirror) {
  ...
  public List<String> getGroupBy() {
    return arguments.get(INPUT_VALUE_GROUP_BY_NAME).asJsonArray().stream()
  ...
  public boolean isUniqueMerge() {
    return hasDirective(DIRECTIVE_UNIQUE_MERGE_NAME);
  }
