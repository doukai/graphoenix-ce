...
public class FieldDefinition extends AbstractDefinition {
  ...
  public FieldDefinition(GraphqlParser.FieldDefinitionContext fieldDefinitionContext) {
    super(
        ...
        fieldDefinitionContext.description(),
        fieldDefinitionContext.directives());
    ...
    addDirective(
        new Directive()
            ...
            .addArgument(
                ...
                async
                    ? getAsyncMethodName(executableElement, types)
            ...
            .addArgument(
                ...
                getTypeWithArgumentsName(executableElement.getReturnType(), types))
  ...
  public FieldDefinition addArguments(Collection<InputValue> arguments) {
    ...
    this.argumentMap.putAll(
        (Map<? extends String, ? extends InputValue>)
            arguments.stream()
                .collect(
                    Collectors.toMap(
                        InputValue::getName,
  ...
  public Optional<Integer> getDecimals() {
    return Optional.ofNullable(getDirective(DIRECTIVE_OPTIONS_NAME))
        .flatMap(
            directive -> directive.getArgumentOrEmpty(DIRECTIVE_OPTIONS_ARGUMENT_DECIMALS_NAME))
        .filter(ValueWithVariable::isInt)
        .map(valueWithVariable -> valueWithVariable.asInt().getIntegerValue());
  }
  ...
  public Optional<EnumValue> getProtocol() {
    return Optional.ofNullable(getDirective(DIRECTIVE_OPTIONS_NAME))
        .flatMap(
            directive -> directive.getArgumentOrEmpty(DIRECTIVE_OPTIONS_ARGUMENT_PROTOCOL_NAME))
  ...
  public boolean isAutoIncrement() {
    return Optional.ofNullable(getDirective(DIRECTIVE_OPTIONS_NAME))
        .flatMap(
            directive ->
                directive.getArgumentOrEmpty(DIRECTIVE_OPTIONS_ARGUMENT_AUTO_INCREMENT_NAME))
  ...
  public Optional<String> getInvokeClassName() {
    return Optional.ofNullable(getDirective(DIRECTIVE_INVOKE_NAME))
        .flatMap(
            directive -> directive.getArgumentOrEmpty(DIRECTIVE_INVOKE_ARGUMENT_CLASS_NAME_NAME))
        .filter(ValueWithVariable::isString)
        .map(valueWithVariable -> valueWithVariable.asString().getValue());
  }
  ...
  public String getInvokeClassNameOrError() {
    return getInvokeClassName()
        .orElseThrow(() -> new GraphQLErrors(CLASS_NAME_DIRECTIVE_NOT_EXIST.bind(toString())));
  }

  public Optional<String> getInvokeMethodName() {
    return Optional.ofNullable(getDirective(DIRECTIVE_INVOKE_NAME))
        .flatMap(
            directive -> directive.getArgumentOrEmpty(DIRECTIVE_INVOKE_ARGUMENT_METHOD_NAME_NAME))
        .filter(ValueWithVariable::isString)
        .map(valueWithVariable -> valueWithVariable.asString().getValue());
  }

  public String getInvokeMethodNameOrError() {
    return getInvokeMethodName()
        .orElseThrow(() -> new GraphQLErrors(METHOD_NAME_ARGUMENT_NOT_EXIST.bind(toString())));
  }
  ...
  public Stream<Map.Entry<String, String>> getInvokeParameters() {
    return Stream.ofNullable(getDirective(DIRECTIVE_INVOKE_NAME))
        .flatMap(
            directive ->
                directive.getArgumentOrEmpty(DIRECTIVE_INVOKE_ARGUMENT_PARAMETER_NAME).stream())
        ...
        .map(
            objectValueWithVariable ->
                new AbstractMap.SimpleEntry<>(
                    ...
                    objectValueWithVariable.getString(
                        INPUT_INVOKE_PARAMETER_INPUT_VALUE_CLASS_NAME_NAME)));
  }
  ...
  public Optional<String> getInvokeReturnClassName() {
    return Optional.ofNullable(getDirective(DIRECTIVE_INVOKE_NAME))
        .flatMap(
            directive ->
                directive.getArgumentOrEmpty(DIRECTIVE_INVOKE_ARGUMENT_RETURN_CLASS_NAME_NAME))
        .filter(ValueWithVariable::isString)
        .map(valueWithVariable -> valueWithVariable.asString().getValue());
  }

  public String getInvokeReturnClassNameOrError() {
    return getInvokeReturnClassName()
        .orElseThrow(
            () -> new GraphQLErrors(RETURN_CLASS_NAME_ARGUMENT_NOT_EXIST.bind(toString())));
  }
  ...
  public String getFunctionNameOrError() {
    return getFunctionName()
        .orElseThrow(() -> new GraphQLErrors(FUNC_NAME_NOT_EXIST.bind(toString())));
  }
  ...
  public String getFunctionFieldOrError() {
    return getFunctionField()
        .orElseThrow(() -> new GraphQLErrors(FUNC_FIELD_NOT_EXIST.bind(toString())));
  }
  ...
  public Optional<String> getConnectionField() {
    return Optional.ofNullable(getDirective(DIRECTIVE_CONNECTION_NAME))
        .flatMap(
            directive -> directive.getArgumentOrEmpty(DIRECTIVE_CONNECTION_ARGUMENT_FIELD_NAME))
        .filter(ValueWithVariable::isString)
        .map(valueWithVariable -> valueWithVariable.asString().getValue());
  }

  public String getConnectionFieldOrError() {
    return getConnectionField()
        .orElseThrow(() -> new GraphQLErrors(CONNECTION_FIELD_NOT_EXIST.bind(toString())));
  }
  ...
  public String getConnectionAggOrError() {
    return getConnectionAgg()
        .orElseThrow(() -> new GraphQLErrors(CONNECTION_AGG_FIELD_NOT_EXIST.bind(toString())));
  }
  ...
  public boolean isMapAnchor() {
    return hasDirective(DIRECTIVE_MAP_NAME)
        && getDirective(DIRECTIVE_MAP_NAME).hasArgument(DIRECTIVE_MAP_ARGUMENT_ANCHOR_NAME)
        && getDirective(DIRECTIVE_MAP_NAME)
            .getArgument(DIRECTIVE_MAP_ARGUMENT_ANCHOR_NAME)
            .isBoolean()
        && getDirective(DIRECTIVE_MAP_NAME)
            .getArgument(DIRECTIVE_MAP_ARGUMENT_ANCHOR_NAME)
            .asBoolean()
  ...
  public boolean hasMapWith() {
    return hasDirective(DIRECTIVE_MAP_NAME)
        && getDirective(DIRECTIVE_MAP_NAME).hasArgument(DIRECTIVE_MAP_ARGUMENT_WITH_NAME);
  }
  ...
  public String getMapFromOrError() {
    return getMapFrom()
        .orElseThrow(() -> new GraphQLErrors(MAP_FROM_ARGUMENT_NOT_EXIST.bind(toString())));
  }
  ...
  public String getMapToOrError() {
    return getMapTo()
        .orElseThrow(() -> new GraphQLErrors(MAP_TO_ARGUMENT_NOT_EXIST.bind(toString())));
  }
    ...
    return Optional.ofNullable(getDirective(DIRECTIVE_MAP_NAME))
        ...
        .flatMap(
            valueWithVariable ->
                valueWithVariable
                    .asObject()
                    .getValueWithVariableOrEmpty(INPUT_WITH_INPUT_VALUE_TYPE_NAME))
        .filter(ValueWithVariable::isString)
        .map(valueWithVariable -> valueWithVariable.asString().getValue());
  }

  public String getMapWithTypeOrError() {
    return getMapWithType()
        .orElseThrow(() -> new GraphQLErrors(MAP_WITH_TYPE_ARGUMENT_NOT_EXIST.bind(toString())));
  }
    ...
    return Optional.ofNullable(getDirective(DIRECTIVE_MAP_NAME))
        ...
        .flatMap(
            valueWithVariable ->
                valueWithVariable
                    .asObject()
                    .getValueWithVariableOrEmpty(DIRECTIVE_MAP_ARGUMENT_FROM_NAME))
        .filter(ValueWithVariable::isString)
        .map(valueWithVariable -> valueWithVariable.asString().getValue());
  }

  public String getMapWithFromOrError() {
    return getMapWithFrom()
        .orElseThrow(() -> new GraphQLErrors(MAP_WITH_FROM_ARGUMENT_NOT_EXIST.bind(toString())));
  }
    ...
    return Optional.ofNullable(getDirective(DIRECTIVE_MAP_NAME))
        ...
        .flatMap(
            valueWithVariable ->
                valueWithVariable
                    .asObject()
                    .getValueWithVariableOrEmpty(DIRECTIVE_MAP_ARGUMENT_TO_NAME))
        .filter(ValueWithVariable::isString)
        .map(valueWithVariable -> valueWithVariable.asString().getValue());
  }
  ...
  public String getMapWithToOrError() {
    return getMapWithTo()
        .orElseThrow(() -> new GraphQLErrors(MAP_WITH_TO_ARGUMENT_NOT_EXIST.bind(toString())));
  }
  ...
  public boolean isFetchAnchor() {
    return hasDirective(DIRECTIVE_FETCH_NAME)
        ...
        && getDirective(DIRECTIVE_FETCH_NAME)
            .getArgument(DIRECTIVE_FETCH_ARGUMENT_ANCHOR_NAME)
            .isBoolean()
        && getDirective(DIRECTIVE_FETCH_NAME)
            .getArgument(DIRECTIVE_FETCH_ARGUMENT_ANCHOR_NAME)
            .asBoolean()
  ...
  public boolean hasFetchWith() {
    return hasDirective(DIRECTIVE_FETCH_NAME)
        && getDirective(DIRECTIVE_FETCH_NAME).hasArgument(DIRECTIVE_FETCH_ARGUMENT_WITH_NAME);
  }
  ...
  public String getFetchFromOrError() {
    return getFetchFrom()
        .orElseThrow(() -> new GraphQLErrors(FETCH_FROM_ARGUMENT_NOT_EXIST.bind(toString())));
  }
  ...
  public String getFetchToOrError() {
    return getFetchTo()
        .orElseThrow(() -> new GraphQLErrors(FETCH_TO_ARGUMENT_NOT_EXIST.bind(toString())));
  }
    ...
    return Optional.ofNullable(getDirective(DIRECTIVE_FETCH_NAME))
        ...
        .flatMap(
            valueWithVariable ->
                valueWithVariable
                    .asObject()
                    .getValueWithVariableOrEmpty(DIRECTIVE_FETCH_ARGUMENT_WITH_TYPE_NAME))
        .filter(ValueWithVariable::isString)
        .map(valueWithVariable -> valueWithVariable.asString().getValue());
  }

  public String getFetchWithTypeOrError() {
    return getFetchWithType()
        .orElseThrow(() -> new GraphQLErrors(FETCH_WITH_TYPE_ARGUMENT_NOT_EXIST.bind(toString())));
  }
    ...
    return Optional.ofNullable(getDirective(DIRECTIVE_FETCH_NAME))
        ...
        .flatMap(
            valueWithVariable ->
                valueWithVariable
                    .asObject()
                    .getValueWithVariableOrEmpty(DIRECTIVE_FETCH_ARGUMENT_FROM_NAME))
        .filter(ValueWithVariable::isString)
        .map(valueWithVariable -> valueWithVariable.asString().getValue());
  }

  public String getFetchWithFromOrError() {
    return getFetchWithFrom()
        .orElseThrow(() -> new GraphQLErrors(FETCH_WITH_FROM_ARGUMENT_NOT_EXIST.bind(toString())));
  }
    ...
    return Optional.ofNullable(getDirective(DIRECTIVE_FETCH_NAME))
        ...
        .flatMap(
            valueWithVariable ->
                valueWithVariable
                    .asObject()
                    .getValueWithVariableOrEmpty(DIRECTIVE_FETCH_ARGUMENT_TO_NAME))
        .filter(ValueWithVariable::isString)
        .map(valueWithVariable -> valueWithVariable.asString().getValue());
  }

  public String getFetchWithToOrError() {
    return getFetchWithTo()
        .orElseThrow(() -> new GraphQLErrors(FETCH_WITH_TO_ARGUMENT_NOT_EXIST.bind(toString())));
  }
  ...
  public EnumValue getFetchProtocolOrError() {
    return getFetchProtocol()
        .orElseThrow(() -> new GraphQLErrors(FETCH_PROTOCOL_ARGUMENT_NOT_EXIST.bind(toString())));
  }
