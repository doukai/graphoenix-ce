...
public class InterfaceType extends AbstractDefinition implements Definition, FieldsType {
  ...
  public InterfaceType(
    ...
    super(
        interfaceTypeDefinitionContext.name(),
        interfaceTypeDefinitionContext.description(),
        interfaceTypeDefinitionContext.directives());
  ...
  public InterfaceType(
      GraphqlParser.InterfaceTypeExtensionDefinitionContext
          interfaceTypeExtensionDefinitionContext) {
    super(
        interfaceTypeExtensionDefinitionContext.name(),
        null,
        interfaceTypeExtensionDefinitionContext.directives());
    setExtension(true);
  ...
  public InterfaceType merge(
      GraphqlParser.InterfaceTypeDefinitionContext... interfaceTypeDefinitionContexts) {
    return merge(
  ...
  public InterfaceType merge(
      GraphqlParser.InterfaceTypeExtensionDefinitionContext...
          interfaceTypeExtensionDefinitionContexts) {
    return merge(
