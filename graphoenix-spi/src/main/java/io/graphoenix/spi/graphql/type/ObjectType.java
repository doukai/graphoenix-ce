...
public class ObjectType extends AbstractDefinition implements Definition, FieldsType {
  ...
  private final STGroup stGroupFile = StringTemplateLoader.load("stg/type/ObjectType.stg");
  ...
  public ObjectType(GraphqlParser.ObjectTypeDefinitionContext objectTypeDefinitionContext) {
    super(
        objectTypeDefinitionContext.name(),
        objectTypeDefinitionContext.description(),
        objectTypeDefinitionContext.directives());
  ...
  public ObjectType(
      GraphqlParser.ObjectTypeExtensionDefinitionContext objectTypeExtensionDefinitionContext) {
    super(
        objectTypeExtensionDefinitionContext.name(),
        null,
        objectTypeExtensionDefinitionContext.directives());
    setExtension(true);
  ...
  public ObjectType merge(
      GraphqlParser.ObjectTypeDefinitionContext... objectTypeDefinitionContexts) {
    return merge(
        Stream.of(objectTypeDefinitionContexts).map(ObjectType::new).toArray(ObjectType[]::new));
  }

  public ObjectType merge(
      GraphqlParser.ObjectTypeExtensionDefinitionContext... objectTypeExtensionDefinitionContexts) {
    return merge(
  ...
  public ObjectType merge(ObjectType... objectTypes) {
    ...
    fieldDefinitionMap.putAll(
        (Map<? extends String, ? extends FieldDefinition>)
            Stream.concat(
  ...
  public FieldDefinition getIDFieldOrError() {
    return getIDField()
        .orElseThrow(() -> new GraphQLErrors(ID_FIELD_DEFINITION_NOT_EXIST.bind(this.getName())));
  }
