...
public class InputObjectType extends AbstractDefinition implements Definition {
  ...
  public InputObjectType(
    ...
    super(
        inputObjectTypeDefinitionContext.name(),
        inputObjectTypeDefinitionContext.description(),
        inputObjectTypeDefinitionContext.directives());
  ...
  public InputObjectType(
      GraphqlParser.InputObjectTypeExtensionDefinitionContext
          inputObjectTypeExtensionDefinitionContext) {
    super(
        inputObjectTypeExtensionDefinitionContext.name(),
        null,
        inputObjectTypeExtensionDefinitionContext.directives());
    setExtension(true);
  ...
  public InputObjectType merge(
      GraphqlParser.InputObjectTypeDefinitionContext... inputObjectTypeDefinitionContexts) {
    return merge(
  ...
  public InputObjectType merge(
      GraphqlParser.InputObjectTypeExtensionDefinitionContext...
          inputObjectTypeExtensionDefinitionContexts) {
    return merge(
