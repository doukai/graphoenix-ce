...
public interface ValueWithVariable extends JsonValue {
    ...
    static <T extends JsonValue> ValueWithVariable of(T value) {
        if (value instanceof ValueWithVariable) {
            ...
            return new io.graphoenix.core.operation.StringValue(((JsonString) value).getString());
    ...
    static ValueWithVariable of(GraphqlParser.ValueWithVariableContext valueWithVariableContext) {
        if (valueWithVariableContext.NullValue() != null) {
            ...
            return new io.graphoenix.core.operation.StringValue(valueWithVariableContext.StringValue());
    ...
    static ValueWithVariable of(Object value) {
        if (value == null) {
            ...
            return new io.graphoenix.core.operation.StringValue((String) value);
        } else if (value instanceof LocalDate) {
            return new io.graphoenix.core.operation.StringValue((LocalDate) value);
        } else if (value instanceof LocalTime) {
            return new io.graphoenix.core.operation.StringValue((LocalTime) value);
        } else if (value instanceof LocalDateTime) {
            return new io.graphoenix.core.operation.StringValue((LocalDateTime) value);
        } else if (value instanceof Character) {
            return new io.graphoenix.core.operation.StringValue((Character) value);
