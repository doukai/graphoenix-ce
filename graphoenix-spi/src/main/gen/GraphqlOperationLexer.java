...
public class GraphqlOperationLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"REPEATABLE", "NAME", "IntValue", "IntegerPart", "NegativeSign", "NonZeroDigit", 
			"FloatValue", "FractionalPart", "ExponentPart", "ExponentIndicator", 
			"Sign", "Digit", "StringValue", "BlockStringCharacter", "StringCharacter", 
			"EscapedCharacter", "EscapedUnicode", "Hex", "ExtendedSourceCharacter", 
