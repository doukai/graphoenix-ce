...
public class ConnectionProvider {
  ...
  public ConnectionProvider(
      ConnectionCreator connectionCreator, Provider<Mono<Connection>> connectionMonoProvider) {
  ...
  public Mono<Void> close(Connection connection) {
    return inTransaction()
        .flatMap(inTransaction -> inTransaction ? Mono.empty() : Mono.from(connection.close()));
  }
}
