...
public class ConnectionPoolCreator {
  ...
  public ConnectionPoolCreator(
      ConnectionFactoryCreator connectionFactoryCreator, R2DBCConfig r2DBCConfig) {
  ...
  private ConnectionPool createConnectionPool(R2DBCConfig r2DBCConfig) {
    ConnectionPoolConfiguration poolConfiguration =
        ConnectionPoolConfiguration.builder(connectionFactoryCreator.createFactory())
            .acquireRetry(r2DBCConfig.getAcquireRetry())
            .backgroundEvictionInterval(
                Duration.ofMillis(r2DBCConfig.getBackgroundEvictionIntervalMillis()))
            ...
            .maxCreateConnectionTime(
                Duration.ofMillis(r2DBCConfig.getMaxCreateConnectionTimeMillis()))
