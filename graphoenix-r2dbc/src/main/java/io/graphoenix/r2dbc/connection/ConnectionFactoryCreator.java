      ...
      ConnectionFactoryOptions options =
          ConnectionFactoryOptions.builder()
              ...
              .option(
                  ...
                  Duration.ofMillis(r2DBCConfig.getConnectTimeoutMillis()))
              .option(
                  ConnectionFactoryOptions.LOCK_WAIT_TIMEOUT,
                  Duration.ofMillis(r2DBCConfig.getLockWaitTimeoutMillis()))
              .option(
                  ConnectionFactoryOptions.STATEMENT_TIMEOUT,
                  Duration.ofMillis(r2DBCConfig.getStatementTimeoutMillis()))
