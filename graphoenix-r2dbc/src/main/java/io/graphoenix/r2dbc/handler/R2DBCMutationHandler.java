...
public class R2DBCMutationHandler implements MutationHandler {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(R2DBCMutationHandler.class.getName());
    ...
    if (r2DBCConfig.getAllowMultiQueries()) {
      if (groupSize != null) {
        return mutationExecutor
            .executeMutationsInBatchByGroup(
                mutationTranslator.operationToStatementSQLStream(operation), groupSize)
        ...
        return mutationExecutor
            .executeMutations(mutationTranslator.operationToStatementSQLStream(operation))
      ...
      return mutationExecutor
          .executeMutationsFlux(mutationTranslator.operationToStatementSQLStream(operation))
