...
public class R2DBCConfig {
  ...
  @Optional private String driver;

  @Optional private String protocol = "pipes";

  private String database;

  @Optional private String host = "localhost";
  ...
  @Optional private Boolean createTables = true;

  @Optional private Boolean ssl = false;

  @Optional private Integer connectTimeoutMillis = 10 * 1000;

  @Optional private Integer lockWaitTimeoutMillis = -1;

  @Optional private Integer statementTimeoutMillis = -1;

  @Optional private Boolean allowMultiQueries = true;

  @Optional private Boolean usePool = false;

  @Optional private Integer acquireRetry = 1;

  @Optional private Integer backgroundEvictionIntervalMillis = -1;

  @Optional private Integer initialSize = 10;

  @Optional private Integer maxSize = 10;

  @Optional private Integer minIdle = 10;

  @Optional private Integer maxAcquireTimeMillis = -1;

  @Optional private Integer maxCreateConnectionTimeMillis = -1;

  @Optional private Integer maxIdleTimeMillis = -1;

  @Optional private Integer maxLifeTimeMillis = -1;

  @Optional private Integer maxValidationTimeMillis = -1;
