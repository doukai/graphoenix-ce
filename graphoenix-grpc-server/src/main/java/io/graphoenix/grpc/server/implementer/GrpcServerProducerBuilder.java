...
public class GrpcServerProducerBuilder {
  ...
  @Inject
  public GrpcServerProducerBuilder(
  ...
  private TypeSpec buildGrpcServerBuilder(List<String> packageNameList) {
    TypeSpec.Builder builder =
        TypeSpec.classBuilder("GrpcServerProducer")
    ...
    MethodSpec.Builder methodBuilder =
        MethodSpec.methodBuilder("server")
            ...
            .addStatement(
                "ServerBuilder<?> serverBuilder = $T.forPort(grpcServerConfig.getPort())",
              ...
              .anyMatch(
                  objectType ->
                      !documentManager.isOperationType(objectType)
                          ...
                          && objectType
                              .getPackageName()
                              .orElseGet(packageConfig::getPackageName)
                              .equals(packageName))) {
