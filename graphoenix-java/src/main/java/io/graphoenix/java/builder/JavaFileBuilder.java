  ...
  public Stream<JavaFile> buildJavaFileList() {
    return Streams.concat(
        documentManager
            ...
            .map(
                typeSpec ->
                    JavaFile.builder(packageConfig.getDirectivePackageName(), typeSpec).build()),
        documentManager
            .getDocument()
            .getEnums()
            .filter(packageManager::isOwnPackage)
            ...
            .map(
                typeSpec ->
                    JavaFile.builder(packageConfig.getEnumTypePackageName(), typeSpec).build()),
        documentManager
            .getDocument()
            .getInterfaceTypes()
            .filter(packageManager::isOwnPackage)
            ...
            .map(
                typeSpec ->
                    JavaFile.builder(packageConfig.getInterfaceTypePackageName(), typeSpec)
                        .build()),
        documentManager
            .getDocument()
            .getInputObjectTypes()
            ...
            .map(
                typeSpec ->
                    JavaFile.builder(packageConfig.getInputObjectTypePackageName(), typeSpec)
                        .build()),
        documentManager
            .getDocument()
            .getInputObjectTypes()
            ...
            .map(
                typeSpec ->
                    JavaFile.builder(packageConfig.getAnnotationPackageName(), typeSpec).build()),
        typeSpecBuilder
            .buildOperationTypeAnnotations()
            .map(
                typeSpec ->
                    JavaFile.builder(packageConfig.getAnnotationPackageName(), typeSpec).build()),
        documentManager
            ...
            .map(
                typeSpec ->
                    JavaFile.builder(packageConfig.getObjectTypePackageName(), typeSpec).build()),
        documentManager
            .getDocument()
            .getObjectTypes()
