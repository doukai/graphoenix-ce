                    ...
                    .filter(
                        objectValueWithVariable ->
                            objectValueWithVariable.getBoolean(
                                INPUT_INVOKE_INPUT_VALUE_ON_FIELD_NAME, false))
                    .map(
                        objectValueWithVariable ->
                                ...
                                Streams.concat(
                                                ...
                                                fieldDefinition -> {
                                                  ...
                                                  ClassName returnClassName =
                                                      toClassName(
                                                          getClassName(
                                                              fieldDefinition
                                                                  .getInvokeReturnClassNameOrError()));
                                                  boolean async = fieldDefinition.isAsyncInvoke();

                                                  String apiVariableName =
                                                      typeNameToFieldName(
                                                          toClassName(invokeClassName)
                                                              .simpleName());
                                                  String fieldSetterMethodName =
                                                  ...
                                                  if (async) {
                                                    invokeCodeBlock =
                                                        CodeBlock.of(
                                                            "return $L.get().async($S, $L).map(sync -> ($T)sync).doOnNext($L -> $L.$L($L));",
                                                            apiVariableName,
                                                            methodName,
                                                            resultParameterName,
                                                            returnClassName,
                                                    ...
                                                    invokeCodeBlock =
                                                        CodeBlock.of(
                                                            "return $L.get().$L($L).doOnNext($L -> $L.$L($L));",
                                                            apiVariableName,
                                                            methodName,
                                                            resultParameterName,
                                                            getFieldName(fieldDefinition.getName()),
                                                    ...
                                                    invokeCodeBlock =
                                                        CodeBlock.of(
                                                            "return $L.get().$L($L).collectList().doOnNext($L -> $L.$L($L));",
                                                            apiVariableName,
                                                            methodName,
                                                            resultParameterName,
                                                            getFieldName(fieldDefinition.getName()),
                                                    ...
                                                    invokeCodeBlock =
                                                        CodeBlock.of(
                                                            "return $T.justOrEmpty($L.get().$L($L)).doOnNext($L -> $L.$L($L));",
                                                            ClassName.get(Mono.class),
                                                            apiVariableName,
                                                            methodName,
                                                            resultParameterName,
                                        ...
                                        objectType.getFields().stream()
                                            ...
                                            .filter(
                                                fieldDefinition ->
                                                    !documentManager
                                                        .getDirectiveInvokes(fieldDefinition)
                                                        .isEmpty())
                                            .filter(
                                                fieldDefinition ->
                                                    documentManager
                                                        ...
                                                        .anyMatch(
                                                            objectValueWithVariable ->
                                                                objectValueWithVariable.getBoolean(
                                                                    INPUT_INVOKE_INPUT_VALUE_ON_FIELD_NAME,
                                                                    false)))
                                            .map(
                                                fieldDefinition -> {
                                                  CodeBlock caseCodeBlock =
                                                          ...
                                                          .reduce(
                                                              ...
                                                              (codeBlock,
                                                                ...
                                                                boolean async =
                                                                    objectValueWithVariable
                                                                        .getBoolean(
                                                                            INPUT_INVOKE_INPUT_VALUE_ASYNC_NAME,
                                                                            false);
                                                                int parametersCount =
                                                                    objectValueWithVariable
                                                                        .getJsonArray(
                                                              ...
                                                              (x, y) -> y);
                                                  CodeBlock invokeCodeBlock =
                                                      CodeBlock.of("return $L;", invokesCodeBlock);
                                                  return CodeBlock.builder()
                                                      .add(caseCodeBlock)
                                                      .indent()
                                                      .add(invokeCodeBlock)
                                        ...
                                        objectType.getFields().stream()
                                            ...
                                            .map(
                                                fieldDefinition -> {
                                                  ...
                                                  CodeBlock invokeCodeBlock =
                                                      CodeBlock.of(
                                                          "return $T.justOrEmpty($L.$L()).flatMap(item -> $L(item, field)).doOnNext($L -> $L.$L($L));",
                                                          ClassName.get(Mono.class),
                                                          resultParameterName,
                                                          getFieldGetterMethodName(
                                                              fieldDefinition.getName()),
                                        ...
                                        objectType.getFields().stream()
                                            ...
                                            .map(
                                                fieldDefinition -> {
                                                  ...
                                                  CodeBlock invokeCodeBlock =
                                                      CodeBlock.of(
                                                          "return $T.justOrEmpty($L.$L()).flatMapMany($T::fromIterable).flatMap(item-> $L(item, field)).collectList().doOnNext($L -> $L.$L($L));",
                                                          ClassName.get(Mono.class),
                                                          resultParameterName,
                                                          getFieldGetterMethodName(
                                                              fieldDefinition.getName()),
  ...
  private MethodSpec buildOperationTypeInvokeMethod(ObjectType objectType) {
    ...
    MethodSpec.Builder builder =
        MethodSpec.methodBuilder(typeParameterName)
            ...
            .returns(
                ParameterizedTypeName.get(
                    ClassName.get(Mono.class), ClassName.get(JsonValue.class)))
    ...
    return builder
        .addStatement(
            "$T operationType = documentManager.getOperationTypeOrError(operation)",
        ...
        .addStatement(
            CodeBlock.builder()
                ...
                .add(
                    CodeBlock.builder()
                        .add(
                            "String selectionName = $T.ofNullable(field.getAlias()).orElseGet(field::getName);\n",
                                ...
                                Streams.concat(
                                            ...
                                            .map(
                                                fieldDefinition -> {
                                                  ...
                                                  List<Map.Entry<String, String>> parameters =
                                                      fieldDefinition.getInvokeParametersList();
                                                  ClassName returnClassName =
                                                      toClassName(
                                                          getClassName(
                                                              fieldDefinition
                                                              ...
                                                              .map(
                                                                  parameter -> {
                                                                    ...
                                                                    InputValue inputValue =
                                                                        fieldDefinition.getArgument(
                                                                            parameter.getKey());
                                                                    if (documentManager
                                                                        .getInputValueTypeDefinition(
                                                                            inputValue)
                                                                        .isLeaf()) {
                                                                      if (argumentTypeNames.length
                                                                          == 1) {
                                                                        return CodeBlock.of(
                                                                            "jsonb.fromJson(field.getArguments().getArgument($S).toJson(), new $T<$T<$T>>() {}.type)",
                                                                            parameter.getKey(),
                                                                            ClassName.get(
                                                                                TypeDefinition
                                                                                    .class),
                                                                      ...
                                                                      return CodeBlock.of(
                                                                          "jsonb.fromJson(field.getArguments().getArgument($S).toJson(), $T.class)",
                                                                          parameter.getKey(),
                                                                          toClassName(className));
                                                                    } else {
                                                                      if (argumentTypeNames.length
                                                  ...
                                                  if (async) {
                                                    if (parameters.isEmpty()) {
                                                      codeBlockBuilder
                                                          .add(
                                                              "return $L.get().async($S).map(sync -> ($T)sync)\n",
                                                              apiVariableName,
                                                              methodName,
                                                              returnClassName)
                                                          .indent();
                                                      ...
                                                      codeBlockBuilder
                                                          .add(
                                                              "return $L.get().async($S, $L).map(sync -> ($T)sync)\n",
                                                              apiVariableName,
                                                              methodName,
                                                              parametersCodeBlock,
                                                              returnClassName)
                                                    ...
                                                    codeBlockBuilder
                                                        .add(
                                                            "return $T.justOrEmpty($L.get().$L($L))\n",
                                                            ClassName.get(Mono.class),
                                                            apiVariableName,
                                                            methodName,
                                                            parametersCodeBlock)
                                                  ...
                                                  return codeBlockBuilder
                                                      .add(
                                                          ...
                                                          methodName)
                                                      .add(
                                                          ".defaultIfEmpty(new $T<>(selectionName, $T.NULL));",
                                                          ClassName.get(
                                                              AbstractMap.SimpleEntry.class),
                                            ...
                                            .map(
                                                fieldDefinition -> {
                                                  ...
                                                  return CodeBlock.builder()
                                                      ...
                                                      .indent()
                                                      .add(
                                                          "return $L(jsonb.fromJson(jsonValue.asJsonObject().get(selectionName).toString(), $T.class), field)\n",
                                                          methodName,
                                                          toClassName(
                                                              fieldTypeDefinition
                                                                  .getClassNameOrError()))
                                            ...
                                            .map(
                                                fieldDefinition -> {
                                                  ...
                                                  return CodeBlock.builder()
                                                      ...
                                                      .indent()
                                                      .add(
                                                          "return $T.justOrEmpty(($T<$T>) jsonb.fromJson(jsonValue.asJsonObject().get(selectionName).toString(), new $T<$T<$T>>() {}.type))\n",
                                                          ClassName.get(Mono.class),
                                                      ...
                                                      .add(
                                                          ...
                                                          ClassName.get(Flux.class))
                                                      .add(
                                                          ".flatMap(item -> $L(item, field))\n",
                                                          methodName)
                                                      .add(".collectList()\n")
                                                      .add(
                                                          ".map($L ->  jsonProvider.createReader(new $T(jsonb.toJson($L))).readValue())\n",
                                                          methodName,
                                                          ClassName.get(StringReader.class),
                                                          methodName)
                                                      .add(
                                                          ...
                                                          ClassName.get(JsonValue.class))
                                                      .add(
                                                          ".map(jsonArray -> new $T<>(selectionName, operationBuilder.updateJsonValue(field, operationType.getField(field.getName()), jsonArray)));",
                                                          ClassName.get(
                                                              AbstractMap.SimpleEntry.class))
                                                      .unindent()
                                                      .unindent()
                                        ...
                                        Stream.of(
                                            CodeBlock.builder()
                                                ...
                                                .add(
                                                    CodeBlock.of(
                                                        "return $T.justOrEmpty(new $T<>(selectionName, jsonValue.asJsonObject().get(selectionName)));\n",
                                                        ClassName.get(Mono.class),
                                                        ClassName.get(
                                                            AbstractMap.SimpleEntry.class)))
                                                .unindent()
                ...
                .add(".collectList()\n")
                .add(
                    ".map(list -> list.stream().collect($T.toJsonObject()))",
