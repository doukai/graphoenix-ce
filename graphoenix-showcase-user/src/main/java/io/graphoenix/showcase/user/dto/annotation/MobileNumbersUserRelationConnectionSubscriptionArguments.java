...
public @interface MobileNumbersUserRelationConnectionSubscriptionArguments {
  ...
  MobileNumbersUserRelationOrderBy1 orderBy() default @MobileNumbersUserRelationOrderBy1;
  ...
  MobileNumbersUserRelationExpression1[] exs() default {};
