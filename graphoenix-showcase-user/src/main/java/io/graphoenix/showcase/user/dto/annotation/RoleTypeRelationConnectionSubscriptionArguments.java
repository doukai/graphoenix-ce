...
public @interface RoleTypeRelationConnectionSubscriptionArguments {
  ...
  RoleTypeExpression1 typeRef() default @RoleTypeExpression1;
  ...
  RoleTypeRelationOrderBy1 orderBy() default @RoleTypeRelationOrderBy1;
  ...
  RoleTypeRelationExpression1[] exs() default {};
