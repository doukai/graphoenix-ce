...
public @interface __DirectiveExpressionBase1 {
  /** id */
  @Description("id")
  ...
  __DirectiveLocationsRelationExpression2 __directiveLocationsRelation() default
      @__DirectiveLocationsRelationExpression2;
