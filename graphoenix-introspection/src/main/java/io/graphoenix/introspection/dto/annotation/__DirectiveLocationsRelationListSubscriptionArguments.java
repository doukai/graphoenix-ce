...
public @interface __DirectiveLocationsRelationListSubscriptionArguments {
  ...
  __DirectiveLocationsRelationOrderBy1 orderBy() default @__DirectiveLocationsRelationOrderBy1;
