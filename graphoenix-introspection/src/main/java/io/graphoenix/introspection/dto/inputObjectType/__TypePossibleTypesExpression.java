...
public class __TypePossibleTypesExpression implements MetaExpression {
  ...
  private __TypePossibleTypesGroupBy groupBy;
  ...
  public Collection<__TypePossibleTypesExpression> __dslJson_exs() {
    return this.exs;
  }
  ...
  public void __dslJson_exs(Collection<__TypePossibleTypesExpression> exs) {
    this.exs = exs;
  }
  ...
  public __TypePossibleTypesGroupBy getGroupBy() {
    return this.groupBy;
  }

  public void setGroupBy(__TypePossibleTypesGroupBy groupBy) {
