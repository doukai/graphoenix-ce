...
public class __InputValueExpression implements MetaExpression {
  ...
  private __InputValueGroupBy groupBy;
  ...
  public Collection<__InputValueExpression> __dslJson_exs() {
    return this.exs;
  }
  ...
  public void __dslJson_exs(Collection<__InputValueExpression> exs) {
    this.exs = exs;
  }
  ...
  public __InputValueGroupBy getGroupBy() {
    return this.groupBy;
  }

  public void setGroupBy(__InputValueGroupBy groupBy) {
