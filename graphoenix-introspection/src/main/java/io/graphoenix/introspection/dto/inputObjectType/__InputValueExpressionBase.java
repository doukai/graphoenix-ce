...
public interface __InputValueExpressionBase extends MetaExpression {
  /**
   * id
   */
  @Description("id")
   ...
   */
  @Description("fieldId")
  IntExpression fieldId = null;

  /**
   * directiveName
   */
  @Description("directiveName")
  StringExpression directiveName = null;
  ...
  StringExpression defaultValue = null;
  ...
  default IntExpression getFieldId() {
    return fieldId;
  }

  void setFieldId(IntExpression fieldId);

  default StringExpression getDirectiveName() {
    return directiveName;
  }

  void setDirectiveName(StringExpression directiveName);
  ...
  default StringExpression getDefaultValue() {
    return defaultValue;
  }

  void setDefaultValue(StringExpression defaultValue);
