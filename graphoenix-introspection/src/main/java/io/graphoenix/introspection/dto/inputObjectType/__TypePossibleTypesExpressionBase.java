...
public interface __TypePossibleTypesExpressionBase extends MetaExpression {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("__Type Reference")
  StringExpression possibleTypeRef = null;

  /**
   * __Type
   */
  @Description("__Type")
  __TypeExpression possibleType = null;
  ...
  Collection<__TypePossibleTypesExpression> exs = null;
  ...
  default StringExpression getPossibleTypeRef() {
    return possibleTypeRef;
  }

  void setPossibleTypeRef(StringExpression possibleTypeRef);

  default __TypeExpression getPossibleType() {
    return possibleType;
  }

  void setPossibleType(__TypeExpression possibleType);
  ...
  default Collection<__TypePossibleTypesExpression> getExs() {
    return exs;
  }

  void setExs(Collection<__TypePossibleTypesExpression> exs);
}
