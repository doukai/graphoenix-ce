...
/**
 * Query Arguments for __Type Connection
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Query Arguments for __Type Connection")
public class __TypeConnectionQueryArguments implements MetaExpression, __TypeExpressionBase {
  /**
   * id
   */
  @Description("id")
  ...
  public __TypeGroupBy getGroupBy() {
    return this.groupBy;
  }

  public void setGroupBy(__TypeGroupBy groupBy) {
