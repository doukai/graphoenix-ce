...
public @interface __Type__TypeRelationConnectionSubscriptionArguments {
  StringExpression1 id() default @StringExpression1;

  StringExpression1 __TypeRef() default @StringExpression1;
  ...
  __Type__TypeRelationOrderBy1 orderBy() default @__Type__TypeRelationOrderBy1;
  ...
  __Type__TypeRelationExpression1[] exs() default {};
