...
public class IntrospectionBuilder {
  ...
  public static final int INTROSPECTION_BUILD_SCOPE_EVENT_PRIORITY =
      DOCUMENT_INITIALIZED_SCOPE_EVENT_PRIORITY + 200;
  ...
  public Mono<Void> buildIntrospection(
      @Observes
          @Initialized(ApplicationScoped.class)
          @Priority(IntrospectionBuilder.INTROSPECTION_BUILD_SCOPE_EVENT_PRIORITY)
          Object event) {
