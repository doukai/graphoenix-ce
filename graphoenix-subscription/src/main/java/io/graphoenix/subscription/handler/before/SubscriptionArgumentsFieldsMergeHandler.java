...
@ApplicationScoped
@Priority(750)
public class SubscriptionArgumentsFieldsMergeHandler implements OperationBeforeHandler {
    ...
    @Inject
    public SubscriptionArgumentsFieldsMergeHandler(DocumentManager documentManager) {
    ...
    public Mono<Operation> subscription(Operation operation, Map<String, JsonValue> variables) {
        ...
        return Flux.fromStream(operation.getFields().stream())
