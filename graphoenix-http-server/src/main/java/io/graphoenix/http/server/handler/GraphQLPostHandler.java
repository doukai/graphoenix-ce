                  ...
                  .flatMapMany(
                      graphQLRequest ->
                          Mono.just(new Document(graphQLRequest.getQuery()))
                              .doOnSuccess(
                                  document ->
                                      requestBeanScoped.put(requestId, Document.class, document))
                              ...
                              .flatMapMany(
                                  operation ->
                                      ScopeEventPublisher.initialized(
                                          ...
                                          .doOnSuccess(
                                              v ->
                                                  requestBeanScoped.put(
                                                      requestId, HttpServerRequest.class, request))
                                          .doOnSuccess(
                                              v ->
                                                  requestBeanScoped.put(
                                                      requestId,
                                          ...
                                          .doOnSuccess(
                                              v ->
                                                  requestBeanScoped.put(
                                                      requestId, Operation.class, operation))
                                          .thenMany(
                                              Flux.from(
                                  ...
                                  operation ->
                                      ScopeEventPublisher.initialized(
                                          ...
                                          .then(
                                              Mono.from(
                                                  operationHandler.handle(
                                                      operation, graphQLRequest.getVariables())))))
