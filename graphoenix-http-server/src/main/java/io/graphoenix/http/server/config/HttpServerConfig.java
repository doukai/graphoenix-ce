...
public class HttpServerConfig {
  ...
  @Optional private String graphqlContextPath = "graphql";

  @Optional private String subscriptionsContextPath = "subscriptions";

  @Optional private String schemaContextPath = "schema";

  @Optional private String downloadContextPath = "download";

  @Optional private Integer port = 8080;

  @Optional private Boolean tcpNoDelay = true;

  @Optional private Boolean soKeepAlive = false;

  @Optional private Integer soBackLog = 128;

  @Optional private Integer connectTimeOutMillis = 30 * 1000;

  @Optional private Integer sessionTimeOutMillis = 30 * 60 * 1000;
