...
public class GraphQLRequest {
  ...
  public static GraphQLRequest fromJson(JsonObject jsonObject) {
    return new GraphQLRequest(
        jsonObject.containsKey("query") && !jsonObject.isNull("query")
            ? jsonObject.getString("query")
            : null,
        jsonObject.containsKey("operationName") && !jsonObject.isNull("operationName")
            ? jsonObject.getString("operationName")
            : null,
        jsonObject.containsKey("variables") && !jsonObject.isNull("variables")
  ...
  public void setFileID(String name, String id) {
    this.variables =
        this.map.getJsonArray(name).stream()
