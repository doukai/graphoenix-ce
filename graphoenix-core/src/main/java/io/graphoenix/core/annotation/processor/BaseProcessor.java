...
public abstract class BaseProcessor extends AbstractProcessor {
  ...
  public void roundInit(RoundEnvironment roundEnv) {
    if (packageConfig.getPackageName() == null) {
      getDefaultPackageName(roundEnv)
          .ifPresent(packageName -> packageConfig.setPackageName(packageName));
    }
  }
        ...
        .addDefinitions(
            roundEnv.getElementsAnnotatedWith(Enum.class).stream()
                ...
                .map(
                    element ->
                        (EnumType)
                            new EnumType((TypeElement) element)
                                .addDirective(
        ...
        .addDefinitions(
            roundEnv.getElementsAnnotatedWith(Interface.class).stream()
                ...
                .map(
                    element ->
                        (InterfaceType)
                            new InterfaceType((TypeElement) element, types)
                                .addDirective(
                                    new Directive(DIRECTIVE_PACKAGE_NAME)
                                        .addArgument(
                                            DIRECTIVE_PACKAGE_ARGUMENT_NAME_NAME,
        ...
        .addDefinitions(
            roundEnv.getElementsAnnotatedWith(Type.class).stream()
                ...
                .map(
                    element ->
                        (ObjectType)
                            new ObjectType((TypeElement) element, types)
                                .addDirective(
                                    new Directive(DIRECTIVE_PACKAGE_NAME)
                                        .addArgument(
                                            DIRECTIVE_PACKAGE_ARGUMENT_NAME_NAME,
        ...
        .addDefinitions(
            roundEnv.getElementsAnnotatedWith(Input.class).stream()
                ...
                .map(
                    element ->
                        (InputObjectType)
                            new InputObjectType((TypeElement) element, types)
                                .addDirective(
                                    new Directive(DIRECTIVE_PACKAGE_NAME)
                                        .addArgument(
                                            DIRECTIVE_PACKAGE_ARGUMENT_NAME_NAME,
                    ...
                    element ->
                        element.getEnclosedElements().stream()
                            ...
                            .map(
                                subElement ->
                                    (EnumType)
                                        new EnumType((TypeElement) subElement)
                                            .addDirective(
                                                new Directive(DIRECTIVE_PACKAGE_NAME)
                                                    .addArgument(
                                                        DIRECTIVE_PACKAGE_ARGUMENT_NAME_NAME,
            ...
            executableElement -> {
              if (executableElement.getAnnotation(Query.class) != null) {
                FieldDefinition fieldDefinition =
                    new FieldDefinition(executableElement, types)
                        .addDirective(
                            new Directive(DIRECTIVE_PACKAGE_NAME)
                                .addArgument(
                                    DIRECTIVE_PACKAGE_ARGUMENT_NAME_NAME,
                    ...
                    .ifPresentOrElse(
                        ...
                        () ->
                            documentManager
                                .getDocument()
                                .addDefinition(
                                    new ObjectType(TYPE_QUERY_NAME).addField(fieldDefinition)));
                    ...
                    .ifPresentOrElse(
                        ...
                        () ->
                            documentManager
                                .getDocument()
                                .addDefinition(
                                    new ObjectType(TYPE_MUTATION_NAME).addField(fieldDefinition)));
              } else if (executableElement.getParameters().stream()
                  .anyMatch(
                      variableElement ->
                          variableElement.getAnnotation(Source.class) != null
                              && types.asElement(variableElement.asType()).getAnnotation(Type.class)
                                  != null)) {
                    ...
                    .ifPresent(
                        variableElement -> {
                          FieldDefinition fieldDefinition =
                              new FieldDefinition(executableElement, types);
                          String typeName =
                              getNameFromElement(types.asElement(variableElement.asType()));
                          documentManager
                              .getDocument()
                              ...
                              .ifPresentOrElse(
                                  ...
                                  () ->
                                      documentManager
                                          .getDocument()
                                          .addDefinition(
                                              new ObjectType(typeName).addField(fieldDefinition)));
                        });
              } else if (executableElement.getParameters().stream()
                  .anyMatch(
                      variableElement ->
                ...
                executableElement.getParameters().stream()
                    ...
                    .ifPresent(
                        variableElement -> {
                          ...
                          documentManager
                              .getDocument()
                              .getImplementsObjectType(typeName)
                ...
                ObjectValueWithVariable invoke =
                                ...
                                .map(
                                    parameter ->
                                        ObjectValueWithVariable.of(
                                            ...
                                            ElementUtil.getTypeWithArgumentsName(
                                                parameter.asType(), types)))
                                .collect(Collectors.toList())),
                        INPUT_INVOKE_INPUT_VALUE_RETURN_CLASS_NAME_NAME,
                        ElementUtil.getTypeWithArgumentsName(
                            executableElement.getReturnType(), types),
                ...
                executableElement.getParameters().stream()
                    ...
                    .ifPresent(
                        inputObjectType ->
                            Optional.ofNullable(
                                    inputObjectType.getDirective(DIRECTIVE_INVOKES_NAME))
                                .ifPresentOrElse(
                                    directive ->
                                        directive
                                            .getArgument(DIRECTIVE_INVOKES_METHODS_NAME)
                                            .asArray()
                                            .add(invoke),
                                    () ->
                                        inputObjectType.addDirective(
                                            new Directive(DIRECTIVE_INVOKES_NAME)
                                                .addArgument(
                                                    DIRECTIVE_INVOKES_METHODS_NAME,
                                                    new ArrayValueWithVariable(invoke)))));
              } else if (executableElement.getParameters().stream()
                  .anyMatch(
                      variableElement ->
                              ...
                              .anyMatch(
                                  annotationMirror ->
                                      annotationMirror
                                              ...
                                              .asElement()
                                              .getAnnotation(
                                                  io.graphoenix.spi.annotation.Directive.class)
                                          != null))) {
                executableElement.getParameters().stream()
                    .flatMap(
                        variableElement ->
                    ...
                    .ifPresent(
                        directiveName -> {
                          ...
                          boolean onInputValue =
                              executableElement.getAnnotation(OnInputValue.class) != null;
                          boolean onExpression =
                              executableElement.getAnnotation(OnExpression.class) != null;
                          ObjectValueWithVariable invoke =
                              ObjectValueWithVariable.of(
                                  INPUT_INVOKE_INPUT_VALUE_PACKAGE_NAME_NAME,
                                  packageConfig.getPackageName(),
                                  ...
                                  onField,
                                  INPUT_INVOKE_INPUT_VALUE_ON_INPUT_VALUE_NAME,
                                  onInputValue,
                                  INPUT_INVOKE_INPUT_VALUE_ON_EXPRESSION_NAME,
                                  onExpression);
                                              ...
                                              () ->
                                                  directiveDefinition.addArgument(
                                                      new InputValue(DIRECTIVE_INVOKES_NAME)
                                                          .setType(
                                                              new ListType(
                                                                  new TypeName(INPUT_INVOKE_NAME)))
                                                          .setDefaultValue(
                                                              ObjectValueWithVariable.of(
                                                                  DIRECTIVE_INVOKES_METHODS_NAME,
                                                                  new ArrayValueWithVariable(
        ...
        .flatMap(
            executableElement ->
                getOperationAnnotationMirror(executableElement)
                    .map(annotationMirror -> buildOperation(executableElement, annotationMirror))
                    .stream());
  }

  public Optional<? extends AnnotationMirror> getOperationAnnotationMirror(
  ...
  public Operation buildOperation(
      ExecutableElement executableElement, AnnotationMirror annotationMirror) {
    TypeElement typeElement = (TypeElement) executableElement.getEnclosingElement();
    int index = typeElement.getEnclosedElements().indexOf(executableElement);
    Map.Entry<? extends ExecutableElement, ? extends AnnotationValue> fieldEntry =
        annotationMirror.getElementValues().entrySet().stream()
            .findFirst()
            .orElseThrow(
                () ->
                    new GraphQLErrors(
                        FIELD_DEFINITION_NOT_EXIST.bind(annotationMirror.toString())));
        ...
        new Operation(
            ...
            .addDirective(
                new Directive()
                    ...
                    .addArgument(
                        DIRECTIVE_INVOKE_ARGUMENT_THROWN_TYPES_NAME,
    ...
    io.graphoenix.spi.graphql.type.Type type =
        executableElementToTypeName(executableElement, types);
                        ...
                        if (level < layers) {
                          return Stream.of(
                              new Field(fieldDefinition.getName())
                                  .setSelections(
                                      buildFields(
                                          fieldTypeDefinition.asObject(), level + 1, layers)));
                        } else {
                          return Stream.empty();
                        }
                      } else {
