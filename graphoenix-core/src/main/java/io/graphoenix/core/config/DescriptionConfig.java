...
public class DescriptionConfig {
  ...
  @Optional private String queryObject = "Query";

  @Optional private String mutationObject = "Mutation";

  @Optional private String subscriptionObject = "Subscription";

  @Optional private String connectionObject = "Connection Object for %s";

  @Optional private String edgeObject = "Edge Object for %s";

  @Optional private String relationObject = "Relationship Object between %s and %s";

  @Optional private String queryExpression = "Query Expression Input for %s";

  @Optional private String mutationInput = "Mutation Input for %s";

  @Optional private String subscriptionExpression = "Subscription Expression Input for %s";
  ...
  @Optional private String queryConnectionArguments = "Query Arguments for %s Connection";

  @Optional private String mutationArguments = "Mutation Arguments for %s";

  @Optional private String mutationListArguments = "Mutation Arguments for %s List";

  @Optional private String subscriptionArguments = "Subscription Arguments for %s";

  @Optional private String subscriptionListArguments = "Subscription Arguments for %s List";

  @Optional
  private String subscriptionConnectionArguments = "Subscription Arguments for %s Connection";

  @Optional private String queryField = "Query Field for %s";

  @Optional private String queryListField = "Query Field for %s List";

  @Optional private String queryConnectionField = "Query Field for %s Connection";

  @Optional private String mutationField = "Mutation Field for %s";

  @Optional private String mutationListField = "Mutation Field for %s List";

  @Optional private String subscriptionField = "Subscription Field for %s";

  @Optional private String subscriptionListField = "Subscription Field for %s List";

  @Optional private String subscriptionConnectionField = "Subscription Field for %s Connection";

  @Optional private String idField = "ID";

  @Optional private String deprecatedField = "Is Deprecated";

  @Optional private String refField = "%s Reference";

  @Optional private String typeNameField = "Type Name";

  @Optional private String connectionField = "Connection Field for %s";

  @Optional private String aggField = "Aggregate Field for %s";

  @Optional private String totalCountField = "Total";

  @Optional private String pageInfoField = "Page Info";

  @Optional private String edgesField = "Edges";

  @Optional private String nodeField = "Node";

  @Optional private String cursorField = "Cursor";

  @Optional private String countField = "Count of %s";

  @Optional private String sumField = "Sum of %s";

  @Optional private String avgField = "Avg of %s";

  @Optional private String maxField = "Max of %s";
  ...
  @Optional private String createUserIdField = "Create User ID";

  @Optional private String createTimeField = "Create Time";

  @Optional private String updateUserIdField = "Update User ID";

  @Optional private String updateTimeField = "Update Time";

  @Optional private String createGroupIdField = "Create Group ID";

  @Optional private String oprArgument = "Operators";

  @Optional private String valArgument = "Value";

  @Optional private String arrArgument = "Array";

  @Optional private String firstArgument = "First";

  @Optional private String lastArgument = "Last";

  @Optional private String offsetArgument = "Offset";

  @Optional private String sortArgument = "Sort";

  @Optional private String afterArgument = "After";

  @Optional private String beforeArgument = "Before";
  ...
  @Optional private String notArgument = "Not";
  ...
  @Optional private String inputArgument = "Input";

  @Optional private String listArgument = "Input List";
