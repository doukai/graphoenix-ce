...
public class PackageConfig {
  ...
  @Optional private String packageLoadBalance = LOAD_BALANCE_ROUND_ROBIN;

  @Optional private String defaultFetchProtocol = Hammurabi.ENUM_PROTOCOL_ENUM_VALUE_GRPC;

  @Optional private Map<String, Object> members;

  @Optional private Set<String> localPackageNames;

  @Optional private String grpcPackageName;

  @Optional private String objectTypePackageName;

  @Optional private String interfaceTypePackageName;

  @Optional private String unionTypePackageName;

  @Optional private String enumTypePackageName;

  @Optional private String inputObjectTypePackageName;

  @Optional private String directivePackageName;

  @Optional private String annotationPackageName;

  @Optional private String modulePackageName;

  @Optional private String handlerPackageName;

  @Optional private String operationPackageName;

  @Optional private String grpcObjectTypePackageName;

  @Optional private String grpcInterfaceTypePackageName;

  @Optional private String grpcUnionTypePackageName;

  @Optional private String grpcEnumTypePackageName;

  @Optional private String grpcInputObjectTypePackageName;

  @Optional private String grpcDirectivePackageName;

  @Optional private String grpcHandlerPackageName;
  ...
  public String getInterfaceTypePackageName() {
    return interfaceTypePackageName != null
        ? interfaceTypePackageName
        : packageName + ".dto.interfaceType";
  }
  ...
  public String getInputObjectTypePackageName() {
    return inputObjectTypePackageName != null
        ? inputObjectTypePackageName
        : packageName + ".dto.inputObjectType";
  }
  ...
  public String getGrpcObjectTypePackageName() {
    return grpcObjectTypePackageName != null
        ? grpcObjectTypePackageName
        : getObjectTypePackageName() + ".grpc";
  }
  ...
  public String getGrpcInterfaceTypePackageName() {
    return grpcInterfaceTypePackageName != null
        ? grpcInterfaceTypePackageName
        : getInterfaceTypePackageName() + ".grpc";
  }
  ...
  public String getGrpcUnionTypePackageName() {
    return grpcUnionTypePackageName != null
        ? grpcUnionTypePackageName
        : getUnionTypePackageName() + ".grpc";
  }
  ...
  public String getGrpcEnumTypePackageName() {
    return grpcEnumTypePackageName != null
        ? grpcEnumTypePackageName
        : getEnumTypePackageName() + ".grpc";
  }
  ...
  public String getGrpcInputObjectTypePackageName() {
    return grpcInputObjectTypePackageName != null
        ? grpcInputObjectTypePackageName
        : getInputObjectTypePackageName() + ".grpc";
  }
  ...
  public String getGrpcDirectivePackageName() {
    return grpcDirectivePackageName != null
        ? grpcDirectivePackageName
        : getDirectivePackageName() + ".grpc";
  }
  ...
  public String getGrpcHandlerPackageName() {
    return grpcHandlerPackageName != null
        ? grpcHandlerPackageName
        : getHandlerPackageName() + ".grpc";
  }
