...
public class GraphQLConfig {
  ...
  @Optional private String graphQL;

  @Optional private String graphQLFileName;

  @Optional private String graphQLPath = "graphql";

  @Optional private Boolean buildIntrospection = false;

  @Optional private Boolean mapToLocalFetch = false;

  @Optional private String defaultOperationHandlerName;
