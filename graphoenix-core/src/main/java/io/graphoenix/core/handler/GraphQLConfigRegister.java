...
public class GraphQLConfigRegister {
  ...
  @Inject
  public GraphQLConfigRegister(
      GraphQLConfig graphQLConfig, PackageConfig packageConfig, DocumentManager documentManager) {
  ...
  public void registerConfig(ClassLoader classLoader) throws IOException {
    if (graphQLConfig.getGraphQL() != null) {
      ...
      documentManager
          .getDocument()
          .addDefinitionsByFileName(graphQLConfig.getGraphQLFileName(), classLoader);
      logger.info("registered file {}", graphQLConfig.getGraphQLFileName());
    } else if (graphQLConfig.getGraphQLPath() != null) {
      documentManager
          .getDocument()
          .addDefinitionsByPathName(graphQLConfig.getGraphQLPath(), classLoader);
      logger.info("registered path {}", graphQLConfig.getGraphQLPath());
    }
  }
              ...
              new FileInputStream(
                  new File(
                      Paths.get(resourcePath)
                          .resolve(graphQLConfig.getGraphQLFileName())
                          .toUri())));
      logger.info("registered file {}", graphQLConfig.getGraphQLFileName());
    } else if (graphQLConfig.getGraphQLPath() != null) {
      documentManager
          .getDocument()
          .addDefinitionsByPathName(graphQLConfig.getGraphQLPath(), resourcePath);
      logger.info("registered path {}", graphQLConfig.getGraphQLPath());
    }
  }
  ...
  public void registerConfig(Filer filer) throws IOException {
    if (graphQLConfig.getGraphQL() != null) {
      ...
      documentManager
          .getDocument()
          .addDefinitions(getResource(filer, graphQLConfig.getGraphQLFileName()));
      logger.info("registered file {}", graphQLConfig.getGraphQLFileName());
    } else if (graphQLConfig.getGraphQLPath() != null) {
      documentManager
          .getDocument()
          .addDefinitionsByPath(graphQLConfig.getGraphQLPath(), getResourcesPath(filer));
      documentManager
          .getDocument()
          .addDefinitionsByPath(graphQLConfig.getGraphQLPath(), getTestResourcesPath(filer));
      logger.info("registered path {}", graphQLConfig.getGraphQLPath());
    }
  }
  ...
  public void register(ClassLoader classLoader, boolean application)
        ...
        .filter(
            path ->
                application
                    || !path.getFileName()
                            .toString()
                            .equals(packageConfig.getPackageName() + ".gql")
                        && !path.getFileName()
                            .toString()
                            .equals(packageConfig.getPackageName() + ".graphql"))
        .forEach(
            path -> {
              try {
