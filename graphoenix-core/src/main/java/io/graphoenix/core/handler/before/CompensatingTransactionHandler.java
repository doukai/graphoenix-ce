...
@ApplicationScoped
@Priority(CompensatingTransactionHandler.VERSION_VALIDATION_HANDLER_PRIORITY)
public class CompensatingTransactionHandler implements OperationBeforeHandler {
    ...
    @Inject
    public CompensatingTransactionHandler(DocumentManager documentManager, JsonProvider jsonProvider, Provider<OperationHandler> operationHandlerProvider, MutationConfig mutationConfig) {
