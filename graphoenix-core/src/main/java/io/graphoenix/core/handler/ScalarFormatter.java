...
public class ScalarFormatter {
  ...
  public JsonValue format(String value, String locale, LocalDateTime localDateTime)
    ...
    if (value != null) {
      DateTimeFormatter formatter =
          DateTimeFormatter.ofPattern(
              value, locale == null ? Locale.getDefault() : Locale.forLanguageTag(locale));
  ...
  public JsonValue format(String value, String locale, LocalDate localDate)
      throws ClassCastException {
    if (localDate == null) {
      return NULL;
    }
  ...
  public JsonValue format(String value, String locale, LocalTime localTime)
      throws ClassCastException {
    if (localTime == null) {
      return NULL;
    }
    ...
    if (value != null) {
      ...
      decimalFormat.setDecimalFormatSymbols(
          DecimalFormatSymbols.getInstance(
              locale == null ? Locale.getDefault() : Locale.forLanguageTag(locale)));
  ...
  public JsonValue format(String value, String locale, BigInteger number)
      throws ClassCastException {
    if (number == null) {
      return NULL;
    }
  ...
  public JsonValue format(String value, String locale, BigDecimal number)
      throws ClassCastException {
    if (number == null) {
      return NULL;
    }
  ...
  public JsonValue format(String value, String locale, String string) throws ClassCastException {
    ...
    if (value != null) {
      Formatter formatter =
          new Formatter(locale == null ? Locale.getDefault() : Locale.forLanguageTag(locale));
  ...
  public JsonValue format(String value, String locale, Enum<?> enumValue)
      throws ClassCastException {
    if (enumValue == null) {
      return NULL;
    }
