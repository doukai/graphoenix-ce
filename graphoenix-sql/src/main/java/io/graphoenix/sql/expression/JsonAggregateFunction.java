...
public class JsonAggregateFunction extends net.sf.jsqlparser.expression.JsonAggregateFunction implements Expression {
    ...
    public JsonAggregateFunction withLimit(Limit limit) {
        this.setLimit(limit);
        return this;
    }
