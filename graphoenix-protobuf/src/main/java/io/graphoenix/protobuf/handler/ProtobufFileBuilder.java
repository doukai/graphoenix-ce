...
public class ProtobufFileBuilder {
  ...
  public Map<String, String> buildProto3() {
            ...
            .setOptions(
                Arrays.asList(
                    ...
                    new Option()
                        ...
                        .setValue(packageConfig.getGrpcObjectTypePackageName())))
        ...
        new ProtoFile()
            ...
            .addImports(
                documentManager
                    ...
                    .flatMap(
                        interfaceType ->
                            getFieldDefinitionsScalarImports(interfaceType.getFields()))
                    .filter(StreamUtil.distinctByKey(Import::getName))
                    .collect(Collectors.toList()))
            .setOptions(
                Arrays.asList(
    ...
    protoFileMap.put(
        ...
        new ProtoFile()
            .setOptions(
                ...
                new Option()
                    .setName("java_package")
                    .setValue(packageConfig.getGrpcEnumTypePackageName()))
            .setPkg(packageConfig.getPackageName())
            .setTopLevelDefs(
                documentManager
                    .getDocument()
    ...
    protoFileMap.put(
        ...
        new ProtoFile()
            ...
            .addImports(
                Stream.concat(
                        documentManager.getDocument().getQueryOperationType().stream()
                            .flatMap(
                                objectType ->
                                    getFieldDefinitionsScalarImports(objectType.getFields())),
                        documentManager.getDocument().getQueryOperationType().stream()
                            .flatMap(
                                objectType ->
                                    objectType.getFields().stream()
            ...
            .setPkg(packageConfig.getPackageName())
            .setTopLevelDefs(
                buildQueryRpcRequest().map(Message::toString).collect(Collectors.toList()))
            .toString());
    protoFileMap.put(
        "query_responses",
        new ProtoFile()
            ...
            .setPkg(packageConfig.getPackageName())
            .setTopLevelDefs(
                buildQueryRpcResponse().map(Message::toString).collect(Collectors.toList()))
            .toString());
    protoFileMap.put(
        "mutation_requests",
        new ProtoFile()
            ...
            .setPkg(packageConfig.getPackageName())
            .setTopLevelDefs(
                buildMutationRpcRequest().map(Message::toString).collect(Collectors.toList()))
            .toString());
    protoFileMap.put(
        "mutation_responses",
        new ProtoFile()
            ...
            .setPkg(packageConfig.getPackageName())
            .setTopLevelDefs(
                buildMutationRpcResponse().map(Message::toString).collect(Collectors.toList()))
            .toString());
    protoFileMap.put(
        "query",
        new ProtoFile()
            ...
            .setPkg(packageConfig.getPackageName())
            .setTopLevelDefs(
                buildQueryService().stream().map(Service::toString).collect(Collectors.toList()))
            .toString());
    protoFileMap.put(
        "mutation",
        new ProtoFile()
            ...
            .setPkg(packageConfig.getPackageName())
            .setTopLevelDefs(
                buildMutationService().stream().map(Service::toString).collect(Collectors.toList()))
            .toString());
    protoFileMap.put(
        "graphql",
        new ProtoFile()
  ...
  public Message buildGraphQLRpcRequest() {
    return new Message()
        ...
        .addField(
            new Field().setName("transaction_id").setType("string").setOptional(true).setNumber(2));
  }
            ...
            IntStream.range(0, enumType.getEnumValues().size())
                .mapToObj(
                    index ->
                        new EnumField()
                            .setName(
                                enumType.getEnumValue(index).getName()
                                    + "_"
                                    + getGrpcEnumFieldName(enumType.getName()))
            ...
            IntStream.range(0, interfaceType.getFields().size())
                .mapToObj(
                    index ->
                        new Field()
                            .setName(
                                getGrpcMessageFiledName(interfaceType.getField(index).getName()))
                ...
                .mapToObj(
                    index ->
                        new Field()
                            .setName(
                                getGrpcMessageFiledName(
                                    inputObjectType.getInputValue(index).getName()))
  ...
  private Stream<Import> getFieldDefinitionsScalarImports(
    ...
    return Streams.concat(
        ...
        fieldDefinitions.stream()
            ...
            .filter(
                definition ->
                    definition.getName().equals(SCALA_BIG_INTEGER_NAME)
                        || definition.getName().equals(SCALA_BIG_DECIMAL_NAME))
