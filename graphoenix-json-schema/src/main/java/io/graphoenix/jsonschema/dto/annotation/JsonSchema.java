...
public @interface JsonSchema {
  ...
  JsonSchema1 items() default @JsonSchema1;
  ...
  JsonSchema1[] allOf() default {};

  JsonSchema1[] anyOf() default {};

  JsonSchema1[] oneOf() default {};

  JsonSchema1 not() default @JsonSchema1;

  Property1[] properties() default {};

  @Name("if")
  JsonSchema1 _if() default @JsonSchema1;

  JsonSchema1 then() default @JsonSchema1;

  @Name("else")
  JsonSchema1 _else() default @JsonSchema1;

  Property1[] dependentRequired() default {};
